...
public class MainListAdapter extends BaseAdapter {
    ...
    public MainListAdapter(Context context, ArrayList<Video> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bm = ThumbnailUtils.createVideoThumbnail(video.getUrl(), MediaStore.Images.Thumbnails.MICRO_KIND);
        Bitmap bitmap = ThumbnailUtils.extractThumbnail(bm, 50, 50);
