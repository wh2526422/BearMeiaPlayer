...
public class LrcView extends android.widget.TextView {
    ...
    private float creent_textSize;        //文本大小
    ...
    private void init() {
        ...
        creent_textSize = getResources().getDimensionPixelSize(R.dimen.current_lyrics_text_size);
        not_creent_textSize = getResources().getDimensionPixelSize(R.dimen.not_current_lyrics_text_size);
        textHeight = getResources().getDimensionPixelSize(R.dimen.text_height);
        //高亮部分
    ...
    protected void onDraw(Canvas canvas) {
        ...
        currentPaint.setTextSize(creent_textSize);
        currentPaint.setTypeface(Typeface.SERIF);

        notCurrentPaint.setTextSize(not_creent_textSize);
